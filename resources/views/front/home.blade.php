                ...
                <div class="col-12">
                    <div class="slider-carousel owl-carousel">
                        <div class="single-slider text-center"
                            style="background: url({{ asset($data->foto1) }}) center center; background-size:cover; position:relative">
                        </div>
                        <div class="single-slider text-center"
                            style="background: url({{ asset($data->foto2) }}) center center; background-size:cover; position:relative">
                        </div>
                        <div class="single-slider text-center"
                            style="background: url({{ asset($data->foto3) }}) center center; background-size:cover; position:relative">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="single-icon-box" style="background-image: url({{ asset($item->foto) }})">
                                <div class="icon-box-content">
                                    ...
                                    <div class="iconbox-content-body">
                                        ...
                                        <a class="btn btn-inline read-more-btn" href="{{ route('detailproduk', $item->slug) }}">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="video-img-thumbnail text-center"
                            style="background: url({{ asset($data->foto1) }}) center center; height: 450px; background-size:cover; position:relative">
                            <a class="glightbox video-play" href="{{ $data->video }}">
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                ...
                                <a type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true"
