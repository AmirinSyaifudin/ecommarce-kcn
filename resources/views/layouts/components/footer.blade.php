            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#exampleModalScrollable1">Cara Pembelian</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row ">
            <div class="col-12 text-center">
                <div class="copyright-area ">
                    <p>Copyright © {{ date('Y') }} <strong><span>PT KALA CITRA NUSWANTARA</span></strong>. All Rights
                        Reserved<br><a href="https://dinkopukm.slemankab.go.id/">PT KALA CITRA NUSWANTARA <br>{{-- Kabupaten Sleman --}}</a></p>
                </div>
            </div>
        </div>
    </div>
